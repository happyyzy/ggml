// Auto-extracted from replay_attention_attn_f32_b1_h24_m4352_n4352_k128.cc
#pragma once

#include <CL/cl.h>

namespace ggml_opencl_mldrift_h24_m4352 {
...
static inline bool set_kernel_args(cl_kernel * kernels, cl_mem * buffers, cl_mem * images) {
  ...
  static const unsigned char k0_arg2[] = {0x00, 0x11, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x40, 0x04, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00};
  ...
  static const unsigned char k1_arg2[] = {0x08, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x0c, 0x00, 0x20, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00};
  if (!mldrift_cl_check(clSetKernelArg(kernels[1], 2, 16, k1_arg2), "SetKernelArg val 1:2")) return false;
  static const unsigned char k1_arg3[] = {0x40, 0x04, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00};
  if (!mldrift_cl_check(clSetKernelArg(kernels[1], 3, 16, k1_arg3), "SetKernelArg val 1:3")) return false;
  static const unsigned char k1_arg4[] = {0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
  ...
  static const unsigned char k2_arg4[] = {0x18, 0x00, 0x00, 0x00, 0x40, 0x04, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00};
  if (!mldrift_cl_check(clSetKernelArg(kernels[2], 4, 16, k2_arg4), "SetKernelArg val 2:4")) return false;
  static const unsigned char k2_arg5[] = {0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00};
  ...
  static const unsigned char k3_arg2[] = {0x18, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00};
  if (!mldrift_cl_check(clSetKernelArg(kernels[3], 2, 16, k3_arg2), "SetKernelArg val 3:2")) return false;
  static const unsigned char k3_arg3[] = {0x18, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
  ...
  static const unsigned char k4_arg3[] = {0x18, 0x00, 0x00, 0x00, 0x40, 0x04, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00};
  if (!mldrift_cl_check(clSetKernelArg(kernels[4], 3, 16, k4_arg3), "SetKernelArg val 4:3")) return false;
  static const unsigned char k4_arg4[] = {0x18, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
  ...
  static const unsigned char k5_arg2[] = {0x08, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x0c, 0x00, 0x40, 0x04, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00};
  if (!mldrift_cl_check(clSetKernelArg(kernels[5], 2, 16, k5_arg2), "SetKernelArg val 5:2")) return false;
  static const unsigned char k5_arg3[] = {0x00, 0x11, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
  ...
  static const unsigned char k6_arg4[] = {0x18, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00};
  if (!mldrift_cl_check(clSetKernelArg(kernels[6], 4, 16, k6_arg4), "SetKernelArg val 6:4")) return false;
  static const unsigned char k6_arg5[] = {0x40, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00};
  if (!mldrift_cl_check(clSetKernelArg(kernels[6], 5, 16, k6_arg5), "SetKernelArg val 6:5")) return false;
  static const unsigned char k6_arg6[] = {0x00, 0x98, 0x01, 0x00, 0x40, 0x04, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00};
  ...
  static const unsigned char k7_arg2[] = {0x80, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00};
  ...
  static const unsigned char k8_arg2[] = {0x80, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00};
  ...
  static const unsigned char k9_arg2[] = {0x80, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00};
  ...
  static const unsigned char k10_arg2[] = {0x80, 0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00};
